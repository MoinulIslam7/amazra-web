          ...
          {images.map((img, i) => (
            <button
              ...
              className={cn(
                ...
                i === active ? "border-primary-700" : "border-gray-200 hover:border-gray-400"
              )}
            >
              <Image
        ...
        <tbody>
          {entries.map(([key, value], i) => (
            <tr key={key} className={i % 2 === 0 ? "bg-gray-50" : "bg-white"}>
              <td className="px-4 py-2.5 font-medium text-gray-700 w-2/5 capitalize">
                {key.replace(/_/g, " ")}
              </td>
  ...
  if (!product) {
    return (
      <div className="container-page py-16 text-center">
        ...
        <Link href="/products" className="text-primary-700 hover:underline text-sm">
          Back to products
        </Link>
      </div>
    );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
              <button
                ...
                className="w-10 h-10 flex items-center justify-center text-gray-600 hover:bg-gray-50 text-lg font-medium"
              >
                −
              </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleShare}
              className="flex items-center gap-1.5 px-4 py-2 text-sm border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors"
            >
              <Share2 size={16} />
              Share
            </button>
